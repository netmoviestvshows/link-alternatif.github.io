function getMovie() {
  ...
  //   $.getJSON("https://api.themoviedb.org/3/movie/505642?api_key=94a2f36cd4e27626b6a7a07766a76196&append_to_response=credits,person,videos",
  $.getJSON(
    "https://api.themoviedb.org/3/tv/" +
      id +
      "?api_key=94a2f36cd4e27626b6a7a07766a76196&append_to_response=keywords,credits,person,images,videos",
...
function render(ID) {
  ...
  $.getJSON(
    "https://api.themoviedb.org/3/person/" +
      ID +
      "?api_key=94a2f36cd4e27626b6a7a07766a76196&language=en-US&append_to_response=credits",
    function (data, status) {
      console.log(data, status);
