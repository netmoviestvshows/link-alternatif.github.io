...
//******************************* DEWAPOKER ***************************************/
var urldewapoker = 'https://dew4pokerking.xyz/ref/OMTIE69';

function dewapoker() {
    window.open("https://dew4pokerking.xyz/ref/OMTIE69");
} // login & Link 1

function dewapoker1() {
    window.location.href = "https://dew4pokerking.xyz/ref/OMTIE69";
} // link daftar

function dewapoker2() {
    window.open("https://dew4pokerways.online/register?ref=OMTIE69");
} // link 2

function dewapoker3() {
    window.open("https://d3w4pokerace.com/ref/OMTIE69");
} // link 3

function dewapokerld0() {
    setTimeout(function () { window.location.href = "https://dew4pokerking.xyz/ref/OMTIE69"; }, 100);
} // load 0

function dewapokerld() {
    setTimeout(function () { window.location.href = "https://dew4pokerking.xyz/ref/OMTIE69"; }, 40000);
} // load 1

function dewapokerld2() {
    setTimeout(function () { window.location.href = "https://dew4pokerways.online/ref/OMTIE69"; }, 32000);
} // load 2

function dewapokerld3() {
    setTimeout(function () { window.location.href = "https://d3w4pokerace.com/ref/OMTIE69"; }, 4000);
} // load 3

function dewapokerld4() {
    setTimeout(function () { window.location.href = "https://dew4pokerking.xyz/ref/OMTIE69"; }, 13000);
} // load 4
...
//******************************* KDSLOT777 **************************************/
var urlkdslot ='https://lolamarketkds.store?ref=admin02';

function kdslot() {
    window.open("https://lolamarketkds.store?ref=admin02");
} // login & Link 1

function kdslot1() {
    window.location.href ="https://lolamarketkds.store?ref=admin02";
} // link daftar
...
function kdslotld0() {
    setTimeout(function () { window.location.href = "https://lolamarketkds.store?ref=admin02"; }, 100);
} // load 0

function kdslotld() {
    setTimeout(function () { window.location.href = "https://lolamarketkds.store?ref=admin02"; }, 40000);
} // load 1

function kdslotld2() {
    setTimeout(function () { window.location.href = "https://lolamarketkds.store?ref=admin02"; }, 32000);
} // load 2

function kdslotld3() {
    setTimeout(function () { window.location.href = "https://lolamarketkds.store?ref=admin02"; }, 4000);
} // load 3

function kdslotld4() {
    setTimeout(function () { window.location.href = "https://lolamarketkds.store?ref=admin02"; }, 13000);
} // load 4
