...
//******************************* 9NAGAPOKER ***************************************/
var url9nagapoker = 'https://www.link9np.sbs/ref/ADMIN002';
...
function nagapoker1() {
    window.location.href = "https://www.link9np.sbs/ref/ADMIN002";
} // link daftar
...
function nagapokerld() {
    setTimeout(function () { window.location.href = "https://www.link9np.sbs/ref/ADMIN002"; }, 40000);
} // load

function nagapokerld2() {
    setTimeout(function () { window.location.href = "https://www.link9np.sbs/ref/ADMIN002"; }, 32000);
} // load 2

function nagapokerld3() {
    setTimeout(function () { window.location.href = "https://www.link9np.sbs/ref/ADMIN002"; }, 4000);
} // load 3

function nagapokerld4() {
    setTimeout(function () { window.location.href = "https://www.link9np.sbs/ref/ADMIN002"; }, 13000);
} // load 4

//******************************* DEWAPOKER ***************************************/
var urldewapoker = 'https://dwpks.com/ref/OMTIE69';

function dewapoker() {
    window.open("https://dwpks.com/ref/OMTIE69");
} // login & Link 1

function dewapoker1() {
    window.location.href = "https://dwpks.com/ref/OMTIE69";
} // link daftar
...
function dewapokerld() {
    setTimeout(function () { window.location.href = "https://dwpks.com/ref/OMTIE69"; }, 40000);
} // load

function dewapokerld2() {
    setTimeout(function () { window.location.href = "https://dwpks.com/ref/OMTIE69"; }, 32000);
} // load 2

function dewapokerld3() {
    setTimeout(function () { window.location.href = "https://dwpks.com/ref/OMTIE69"; }, 4000);
} // load 3

function dewapokerld4() {
    setTimeout(function () { window.location.href = "https://dwpks.com/ref/OMTIE69"; }, 13000);
} // load 4
...
//******************************* KDSLOT777 ***************************************/
var urlkdslot ='https://kdslotswin.com/?ref=admin02';

function kdslot() {
    window.open("https://kdslotswin.com/?ref=admin02");
} // login & Link 1

function kdslot1() {
    window.location.href ="https://kdslotswin.com//?ref=admin02";
} // link daftar
...
function kdslotld() {
    setTimeout(function () { window.location.href = "https://kdslotswin.com/?ref=admin02"; }, 40000);
} // load

function kdslotld2() {
    setTimeout(function () { window.location.href = "https://kdslotswin.com/?ref=admin02"; }, 32000);
} // load 2

function kdslotld3() {
    setTimeout(function () { window.location.href = "https://kdslotswin.com/?ref=admin02"; }, 4000);
} // load 3

function kdslotld4() {
    setTimeout(function () { window.location.href = "https://kdslotswin.com/?ref=admin02"; }, 13000);
} // load 4
