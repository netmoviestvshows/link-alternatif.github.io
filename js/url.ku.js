...
//******************************* 9NAGAPOKER ***************************************/
var url9nagapoker = 'https://link9np.top/ref/ADMIN002';

function nagapoker() {
    window.open("https://link9np.top/ref/ADMIN002");
} // login & link1

function nagapoker1() {
    window.location.href = "https://link9np.top/ref/ADMIN002";
} // link daftar

function nagapoker2() {
    window.open("https://www.link9np.buzz/ref/ADMIN002");
} // link 2
...
function nagapokerld0() {
    setTimeout(function () { window.location.href = "https://link9np.top/ref/ADMIN002"; }, 100);
} // load 0

function nagapokerld() {
    setTimeout(function () { window.location.href = "https://link9np.top/ref/ADMIN002"; }, 40000);
} // load

function nagapokerld2() {
    setTimeout(function () { window.location.href = "https://link9np.top/ref/ADMIN002"; }, 32000);
} // load 2

function nagapokerld3() {
    setTimeout(function () { window.location.href = "https://link9np.top/ref/ADMIN002"; }, 4000);
} // load 3

function nagapokerld4() {
    setTimeout(function () { window.location.href = "https://link9np.top/ref/ADMIN002"; }, 13000);
} // load 4

//******************************* DEWAPOKER ***************************************/
var urldewapoker = 'https://senangdwp.com/?ref=OMTIE69';

function dewapoker() {
    window.open("https://senangdwp.com/?ref=OMTIE69");
} // login & Link 1

function dewapoker1() {
    window.location.href = "https://dewap0k3r.com/?ref=OMTIE69";
} // link daftar
...
function dewapokerld3() {
    setTimeout(function () { window.location.href = "https://senangdwp.com/?ref=OMTIE69"; }, 4000);
} // load 3

function dewapokerld4() {
    setTimeout(function () { window.location.href = "https://senangdwp.com/?ref=OMTIE69"; }, 13000);
} // load 4
