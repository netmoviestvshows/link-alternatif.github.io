...
.mejs-duration-container:after {
  ...
  height: 32px;
  cursor: pointer;
  background: url("https://cintakuaja68.github.io/assets/icons/volfull.png") no-repeat;
}
.mejs-controls .mejs-button button {
  font-size: 0;
  line-height: 0;
...
.mejs-container .mejs-controls .mejs-playpause-button button {
  ...
  height: 36px;
  margin: 0;
  background: url("https://cintakuaja68.github.io/assets/icons/star.png") no-repeat;
}
.mejs-container .mejs-controls .mejs-playpause-button button:hover {
  width: 36px;
  height: 36px;
  margin: 0;
  background: url("https://cintakuaja68.github.io/assets/icons/star-hover.png") no-repeat;
}
...
.mejs-container .mejs-controls .mejs-pause button:hover {
  background: url(https://cintakuaja68.github.io/assets/icons/star-hover.png)
    no-repeat;
}
