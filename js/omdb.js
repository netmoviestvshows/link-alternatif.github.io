...
<div class="separator" style="clear: both;"><a href="${data.Poster}" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" height="320" data-original-height="450" data-original-width="300" src="${data.Poster}"/></a></div> 
</div>
